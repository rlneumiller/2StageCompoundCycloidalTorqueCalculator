def calculate_dynamic_torques(motor_torque: float, first_stage_reduction_ratio: int, second_stage_reduction_ratio: int):
    ...
    return {
        ...
        "Second stage ring gear torque": second_stage_ring_gear_torque,
...
# Get user input for motor torque and reduction ratios
motor_torque = float(input("Enter motor torque (Nm): "))
first_stage_reduction_ratio = int(input("Enter first stage reduction ratio: "))
second_stage_reduction_ratio = int(input("Enter second stage reduction ratio: "))
